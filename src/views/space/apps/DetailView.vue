            ...
            <div class="flex flex-col w-1/3 bg-white h-full">
                ...
                <div class="h-full min-h-0 px-6 py-7 overflow-x-hidden overflow-y-scroll scrollbar-w-none">
                    ...
                    <div class="flex flex-row gap-2 mb-6">
                        <!-- 头像 -->
                        <a-avatar :style="{ backgroundColor: '#3370ff' }" class="flex-shirink-0" :size="30">慕</a-avatar>
                        <!-- 实际消息 -->
                    ...
                    <div class="flex flex-row gap-2 mb-6">
                        <!-- 头像 -->
                        <a-avatar :style="{ backgroundColor: '#00d0b6' }" class="flex-shirink-0"
                            :size="30"><icon-apps /></a-avatar>
                        <!-- 实际消息 -->
                        <div class="flex flex-col gap-2">
